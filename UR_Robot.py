...
class UR_Robot:
    def __init__(self, tcp_host_ip="192.168.1.60", tcp_port=30003, workspace_limits=None,
                 is_use_robotiq85=False, is_use_camera=True, is_use_dh95=True):
        # Init varibles
    ...
    def go_home(self):
        ...
        grasp_home = [-0.07805762,-0.2609291,0.43277966,-0.09922904,-3.11583764,0.09816133]  # you can change me
        self.move_j_p(grasp_home, k_acc=1, k_vel=1)
    ...
    def grasp(self, position, rpy=None, open_size=0.85, k_acc=1, k_vel=1, speed=255, force=200):
        ...
        # self.gripper.move_and_wait_for_pos(open_pos, speed, force)
        # self.log_gripper_info()
        self.gripper_pub(position=100.0, force=2.0, speed=20.0)
        ...
        if not no_ik_result:
            ...
            return False
        # self.close_gripper(speed, force)
        self.gripper_pub(position=open_size * 100.0, force=2.0, speed=20.0)
        ...
        box_position = [-0.07805762,-0.2609291,0.43277966,-0.09922904,-3.11583764,0.09816133]  # you can change me!
        self.move_j_p(box_position, k_acc, k_vel)
    ...
    def read_cam_external_parament(self,cam_ext_file_name):
            try:
    ...
    def pose_to_mat44(self,camera_extr):
    ...
    def tcp_transform_base(self,grasp2end):
    ...
    def gripper_pub(self, position, force, speed):
...
if __name__ =="__main__":
    ...
    ur_robot = UR_Robot(tcp_host_ip="192.168.1.60", tcp_port=30003, workspace_limits=None, is_use_robotiq85=False,
                        is_use_camera=True)
    # ur_robot.get_state()
    # ur_robot.go_home()
    # ur_robot.get_state()
    cam2end = ur_robot.cam_pose_calibration
